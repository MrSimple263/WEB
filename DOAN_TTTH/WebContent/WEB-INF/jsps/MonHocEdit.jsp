<%@page import="Model.Groupsubject"%>
...
<body>
<form method="post" action="SubjectEdit"  enctype="multipart/form-data">
	...
	<div><img src="imgsubject/${subject.img}" alt="not find src" style="width: 75px;height: 75px"/></div>
    ...
    <script>
    	...
    	document.getElementById("sel").value =${subject.idgroup};
	</script>
